...
require 'fastlane/plugin/deploy_module_bintray/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-deploy_module_bintray'
  spec.version       = Fastlane::DeployModuleBintray::VERSION
  ...
  spec.add_development_dependency('fastlane', '>= 2.76.1')
end
